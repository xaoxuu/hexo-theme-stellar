...
- 涉及文件：`layout/layout.ejs`、`source/css/_components/sidebar/sidebar.styl`、`_config.yml`、`docs/knowledge/02-布局系统/sidebar-system.md`、`docs/knowledge/02-布局系统/layout-overview.md`。
