...
评论 partial 只接收显式 `comments` local。实际第三方库在评论容器进入视口时经 `util.viewportLazyload` 加载；Artalk URL 含 `?atk_comment=<id>` 或 `#atk-comment-<id>` 时立即初始化，以完成通知链接定位。
...
相关源码：[scripts/lib/models/index.js](../../../scripts/lib/models/index.js)、[layout/_partial/comments/](../../../layout/_partial/comments/)、[scripts/lib/extension-assets.js](../../../scripts/lib/extension-assets.js)、[source/css/comments/](../../../source/css/comments/)。
