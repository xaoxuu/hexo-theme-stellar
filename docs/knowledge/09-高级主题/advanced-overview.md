...
graph TB
    ...
    subgraph "Data Extension"
        DataServices["extensions.services<br/>API endpoints"]
...
| **添加搜索功能** | 搜索服务 | `source/js/search/*.js` | `extensions.search.providers.local` |
| **自定义评论系统** | 评论集成 | `layout/_partial/comments/*.ejs` | `extensions.comments` |
...
flowchart TD
    ...
    CreateTag --> Config2["Register extensions.tags<br/>configuration"]
    EditJS --> Config3["Update extensions.features<br/>or internal assets"]
