...
- **package.json**：`"version": "1.38.0"`，供 npm 分发使用
- **_config.yml**：`stellar.version: '1.38.0'`，用于展示与文档链接
...
```bash
npm install hexo-theme-stellar@1.38.0
```
