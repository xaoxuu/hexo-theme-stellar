...
> Stellar 的视觉体系：设计令牌、CSS 变量、排版、颜色与深色模式、响应式、Stylus 工具混入与代码高亮。
...
- [Stylus 工具与混入](stylus-utilities.md)——过渡、滚动条、玻璃拟态等可复用混入
- [代码块与语法高亮](code-highlighting.md)——代码块结构、语法令牌配色、Gist 集成
