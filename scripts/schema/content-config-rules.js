...
const CONTENT_OVERRIDE_DEFINITIONS = [
  ...
  ["topbar.enabled", ["boolean", "null"], literal(null)],
  ["topbar.brand", ["object", "boolean", "null"], literal(null), { boundary: "sealed" }],
  ["topbar.brand.image", "object", literal({}), { boundary: "sealed" }],
  ["topbar.brand.image.src", ["string", "null"], literal(null)],
  ["topbar.brand.image.variant", ["string", "null"], literal(null), { values: ["avatar", "icon", "plain", null] }],
  ["topbar.brand.name", ["string", "null"], literal(null)],
  ["topbar.brand.tagline", ["string", "null"], literal(null)],
  ["topbar.brand.href", ["string", "null"], literal(null)],
  ["topbar.menu", ["array", "null"], literal(null), { items: MENU_ITEMS }],
