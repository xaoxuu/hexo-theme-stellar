...
function footerSchema(factory, options = {}) {
  ...
  return object({
    ...
    share: field(["boolean", "array", "null"], {
      default: options.shareDefault || computed("普通博客继承 article.footer.share；Collection 默认关闭；Collection 与 Page 可用 true 或服务数组开启"),
      example: true
    }),
...
function renderRegionsSchema(factory) {
  ...
  return {
    ...
    regionWarnings: array(field("object", { additionalProperties: true }), {
      default: literal([]),
      example: [],
      required: true
    })
