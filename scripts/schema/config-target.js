...
const CONFIG_TARGET_FIELDS = deepFreeze([
  ...
  ...fields(CONTENT_CONSUMERS, [
    ...
    ["content.article.listing.card_layout", "string", literal("classic"), { values: ["hero", "classic"] }],
    ["content.article.listing.cover_ratio", "number", literal(2)],
    ["content.article.listing.excerpt_length", "number", literal(128)],
    ["content.article.listing.show_tags", "boolean", literal(false)],
    ["content.article.banner.ratio", "number", literal(2.5)],
    ["content.article.category_colors", "object", literal({}), { boundary: "record" }],
    ...
    ["content.article.footer.license", ["boolean", "string"], literal(true)],
    ...
    ["content.article.related_posts.limit", "number", literal(5)],
    ["content.article.show_reading_time", "boolean", literal(false)],
    ["content.article.show_tags", "boolean", literal(true)],
    ["content.notebook.listing.excerpt_length", "number", literal(128)],
    ["content.notebook.listing.per_page", ["number", "null"], literal(null)],
