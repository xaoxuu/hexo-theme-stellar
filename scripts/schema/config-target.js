...
const CONFIG_DOMAIN_MIGRATIONS = deepFreeze({
  ...
  plugins: [
    ...
    migration("plugins.scrollreveal.distance", "internalize", null, "Reveal 动画参数由主题原生实现统一维护"),
    migration("plugins.scrollreveal.duration", "internalize", null, "Reveal 动画参数由主题原生实现统一维护"),
    migration("plugins.scrollreveal.interval", "internalize", null, "Reveal 动画参数由主题原生实现统一维护"),
    migration("plugins.scrollreveal.scale", "internalize", null, "Reveal 动画参数由主题原生实现统一维护"),
  ...
  style: [
    ...
    migration("style.page_transition.enable", "remove", null, "跨文档 View Transition 已移除，统一使用普通整页导航"),
