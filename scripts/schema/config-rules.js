...
const CONFIG_RULES = Object.freeze([
  ...
  ["services.site_info.site_info_api.endpoint", { type: ["string", "null"], validator: "nullable_absolute_http_url" }],
  ["services.rating.star_vote.endpoint", { type: ["string", "null"], validator: "nullable_absolute_http_url" }],
  ["services.vote.star_vote.endpoint", { type: ["string", "null"], validator: "nullable_absolute_http_url" }],
