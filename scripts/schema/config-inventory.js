...
const CONFIG_DOMAIN_CATALOG = deepFreeze([
  ...
  domain("brand", {
    ...
    consumers: ["PageViewModel", "brand helper", "leftbar renderer"],
    status: "delivered",
  ...
  domain("site_tree", {
    ...
    consumers: ["CollectionModel", "PageViewModel", "page generators", "leftbar renderer"],
    status: "delivered",
    migrationSlice: "shell-content-defaults",
  }),
  domain("notebook", {
  ...
  domain("footer", {
    ...
    consumers: ["PageViewModel", "leftbar footer renderer", "main footer renderer"],
    status: "delivered",
    migrationSlice: "shell-content-defaults",
