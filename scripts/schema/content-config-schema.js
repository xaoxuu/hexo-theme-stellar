...
const LEGACY_COLLECTION_ROOTS = Object.freeze({
  ...
  subtitle: "tagline",
  logo: "leftbar.brand",
  wiki_home: "leftbar.brand.back_button",
  coverpage: "hero.enabled",
  ...
  base_dir: "route.path",
  path: "route.path",
  homepage: "navigation.tree",
  sort: "listing.order",
  pin: "listing.priority",
  order_by: "listing.sort",
  auto_excerpt: "listing.excerpt_length",
  per_page: "listing.per_page",
  note_leftbar: "profiles.note.leftbar.widgets | front matter leftbar.widgets",
  note_rightbar: "profiles.note.rightbar.widgets | front matter rightbar.widgets",
...
const LEGACY_FRONT_MATTER_ROOTS = Object.freeze({
  ...
  beaudar: "comments.options",
  utterances: "comments.options",
  giscus: "comments.options",
  twikoo: "comments.options",
  waline: "comments.options",
  artalk: "comments.options",
  indexing: "visibility.searchable",
  pin: "listing.priority",
  sticky: "listing.priority",
  repo: "source.repository",
  branch: "source.branch",
  nav_tabs: "profiles.blog_index.listing_nav | profiles.wiki_index.listing_nav",
  wiki_home: "collection leftbar.brand.back_button",
