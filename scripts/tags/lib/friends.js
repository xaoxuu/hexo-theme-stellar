  ...
  if (api) {
    ...
    for (let item of (links[args.group] || [])) {
      if (item?.url && item?.title) {
        ...
        el += `<img class="lazy" data-src="${item.appicon || item.icon || item.avatar || ctx.stellar.config.fallbacks.avatar}" onerror="javascript:this.removeAttribute(&quot;data-src&quot;);this.src=&quot;${ctx.stellar.config.fallbacks.avatar}&quot;;"/>`
