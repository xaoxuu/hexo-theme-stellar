...
hexo.extend.tag.register('ghcard', function(args) {
  ...
  if (path.includes('/')) {
    // is repo
    const ps = path.split('/');
    url += 'https://github-readme-stats-frederick-x.vercel.app/api/pin/?username=' + ps[0] + '&repo=' + ps[1];
  } else {
    // is user
    url += 'https://github-readme-stats-frederick-x.vercel.app/api/?username=' + path;
  }
