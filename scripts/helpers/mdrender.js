...
hexo.extend.helper.register('mdrender_html', function (src, options = {}) {
  if (options.rawUrl == null) {
    options.rawUrl = hexo.stellar.config.extensions.services.github.rawUrl;
  }
...
hexo.extend.helper.register('wiki_readme_html', function (proj, page) {
  return wikiReadmeHtml(proj, page, { rawUrl: hexo.stellar.config.extensions.services.github.rawUrl });
});
